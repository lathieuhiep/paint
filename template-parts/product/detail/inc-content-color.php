...
<div class="group-color">
  ...
  foreach ($color_code_list as $color_code_item) :
    ...
    <div class="item">
      <figure class="item__thumbnail" data-image-feature="<?php echo wp_get_attachment_image_url($color_code_item['image_id'], 'full') ?>">
    ...
    <?php if ( $i % 5 == 0 || $i == count($color_code_list) ) : ?>
    </div>
  <?php
  endif;
