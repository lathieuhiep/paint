...
class Paint_Elementor_Content_Box_Grid extends Widget_Base {
    ...
    {
        return 'paint-content-box-grid';
    }

    public function get_title(): string
    {
        return esc_html__( 'Hộp nội dung grid', 'paint' );
    }
    ...
    protected function _register_controls(): void
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 4,
                'selectors' => [
                    '{{WRAPPER}} .element-content-box-grid' => 'grid-template-columns: repeat({{VALUE}}, 1fr);',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .element-content-box-grid' => 'grid-column-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .element-content-box-grid' => 'grid-row-gap: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render(): void
    {
        ...
        <div class="element-content-box-grid">
